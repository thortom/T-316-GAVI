...
class septoktspa:
    def __init__(self,dfUtlendingarGisti):
        self.dfUtlendingarGisti = dfUtlendingarGisti
        self.test(dfUtlendingarGisti)

    def test(self,dfUtlendingarGisti):

        array0,array1,array2,array3,array4 = self.Dataforplot(dfUtlendingarGisti)
        self.plotter(array0,array1,array2,array3,array4)

    def plotter(self,array0,array1,array2,array3,array4):
    ...
    def Dataforplot(self,dfUtlendingarGisti):
        i = 0
        okt = []
        okt_spa = []
        nov = []
