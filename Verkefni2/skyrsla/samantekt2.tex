...
\begin{figure}[H]
	...
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[height=40mm]{pre_dia.jpg}
		\caption{$ Diagram\ fyrir\ einkunnarspa $\label{fig:dia}}	
	\end{subfigure}
\end{figure}
